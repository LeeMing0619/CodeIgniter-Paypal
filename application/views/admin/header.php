...
<html>
        ...
        <div style="background: #33271f;" class="fullheader">
            <div class="container">
                <div class="row">
                    ...
                    <h3 class="class_balance" style="text-align: center; margin-top: -40px; font-size: 36px; font-weight: 900; color: aliceblue;">&pound;<?php echo $this->session->userdata['balance'] == '' ? 0 : $this->session->userdata['balance'];?></h3>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="pull-right">
                            <a class="btn btn-sm btn-info" data-toggle='modal' data-target='#editModal' href="" style="width: 60px;height: 60px;osition: relative;overflow: hidden;border-radius: 50%; padding: 0px;">
                                <?php 
                                    ...
                                    if ($photo != '') {
                                        echo '<img src="'.base_url().'/uploads/photo/'.$photo.'" style="display: inline;   margin: 0 auto;    margin-left: 0%; height: 100%;width: auto;"  id="user_avatar"/>';
                                    } else {
                        ...
                        <li class="pull-right" style="margin-right:10px;">
                            <a class="btn btn-sm btn-infomation" data-toggle='modal' data-target='#helpModal' href="" style="width: 60px;height: 60px;osition: relative;overflow: hidden;border-radius: 50%; padding: 0px;">
                                <img src="<?php echo base_url() ?>/asset/images/i.png" class="user_icon" id="user_avatar"/>
                            </a>
                        </li>
                    </ol>
                </div>
        ...
        <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form  id="frm_deposit" role="form" action="<?php echo base_url() ?>depositproc" method="POST">
                ...
                <tr>
                    <td style="width: 320px;">
                        <?php 
                            $photo = $this->session->userdata['user_photo'];
                            if ($photo != '') {
                                echo '<img src="'.base_url().'/uploads/photo/'.$photo.'" style="display: inline;   margin: 0 auto; height: 300px;width: 300px;"/>';
                            } else {
                                echo '<img src="'.base_url().'/asset/images/account.png" class="user_icon"/>';
                            }
                        ?>
                    </td>
                    <td>
                        <textarea class="form-control prebio" rows="3" maxlength="200" readonly style="resize:none;margin-bottom: 30px;"><?php echo $this->session->userdata['user_bio'];?></textarea>
                        <table style="width: 100%; font-size: x-large;">
                            <tbody style="color: white;">
                                ...
                                <tr>
                                    <td style="text-align: center;"><?php echo $this->session->userdata['wins_cnt'];?></td>
                                    <td style="text-align: center;"><?php echo $this->session->userdata['draws_cnt'];?></td>
                                    <td style="text-align: center;"><?php echo $this->session->userdata['losses_cnt'];?></td>
                                </tr>
                            </thead>
                        </table>
                        
                        <p style="text-align: center; font-size: x-large; font-weight: 900;"> You have played against <font color="red"><?php echo $this->session->userdata['game_cnt'];?></font> different people </p>
                    </td>
                </tr>
                </table>
              </div>
              <div class="modal-footer">
                ...
                <button type="button" data-toggle='modal' data-target='#changeEmail' class="btn btn-primary" id="changemail">ACCOUNT</button>
                <button type="button" data-toggle='modal' data-target='#changeProfile' class="btn btn-primary" id="changeprof">PROFILE</button>
                <button type="button" data-toggle='modal' data-target='#withdraw' class="btn btn-primary" id="submitWithdraw">WITHDRAW</button>
                <button type="button" data-toggle='modal' data-target='#Deposit' class="btn btn-primary" id="deposit">Deposit</button>
                    ...
                    <div class="modal-body">
                        <table id="account-modal" style="width:100%">
                            <tr>
                                ...
                                <td><label class="balance_val"><?php echo $this->session->userdata['balance'] == '' ? '&#163;0' : $this->session->userdata['balance'];?></label></td>
                            </tr>
                            <tr>
                                <td><label>Deposit Methods:</label></td>
                            ...
                            <tr>
                                <td>
                                    <div class=""><label>Amount Deposit:</label></div>
                                </td>
                                <td>
                                    <input type="number" name="depositval" id="depositval" min="1"/><br>
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div class="modal fade" id="withdraw" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title" id="myModalLabel">Withdraw</h3>
              ...
              <form  id="frm_withdraw" role="form" action="<?php echo base_url() ?>withdrawproc" method="POST">
                    <div class="modal-body">
                        <table id="account-modal" style="width:100%">
                           ...
                           <tr>
                                <td>
                                    <div class=""><label>Amount to Withdraw: (Minimum £100.00)</label></div>
                                </td>
                                <td>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                  ...
                  <form  id="frm_email" role="form" action="<?php echo base_url() ?>changeEmail" method="POST">
                    <table>
                        <tr>
                            <td style="text-align: left;font-size: larger; margin-right:10px;">Current Email Address  :</td>
                            <td style="text-align: left;"><?php echo $this->session->userdata['user_email'];?></td>
                        </tr>
                        <tr>
                            <td style="text-align: left;font-size: larger; margin-right:10px;">New Email Address :</td>
                            <td style="text-align: left;"><input type="email" name="newmail" value="" id="newmail" onchange="javascript:onchangeEmail()"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: left;font-size: larger; margin-right:10px;">New Password :</td>
                            <td style="text-align: left;"><input type="password" name="newpwd" id="newpwd" value=""/></td>
                        </tr>
                        <tr>
                            <td style="text-align: left;font-size: larger; margin-right:10px;">Confirm Password:</td>
                            <td style="text-align: left;"><input type="password" name="confirmpwd" id="confirmpwd" value="" onchange="javascript:passwordchange()"/></td>
                        </tr>
                        <tr>
                            <td style="text-align: left;font-size: larger; margin-right:10px;">Receive marketing email?:</td>
                            <td style="text-align: left;"><input type="checkbox" name="market" id="market" style="width: 20px; height: 20px;visibility: visible;"/></td>
                        </tr>
                    </table>
              </div>
              <div class="modal-footer">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                    <div class="row clear_fix">
                        <div class="col-md-4 col-md-offset-4" style="position: relative">
                            <p class="alert alert-danger text-center  login-form" id="response"><b>Change Profile error.</b></p>
                        </div>
                        <style>
                            #response{display: none}
                        </style>
    ...
    font-weight: 600;">online@rpsbet.com</u>.</p>
        ...
        <input type="hidden" class="hidden_email" value="<?php echo $this->session->userdata['user_email']?>"/>
...
<script>
    ...
    $(document).ready(function (){
        $("#frm_profile").submit(function (e){
            ...
            if (photo == '' && bio == '') {
                alert("please select your avatar or enter biography.");
                return false;
            }
            ...
            $.ajax({
               ...
               if (data !='') {
                    ...
                    $(".prebio").val('<?php echo $this->session->userdata['user_bio'];?>');
                    $("#changeProfile").modal('hide');
                    $("#photo").val('');
                    $("#bio").val('');
                    location.reload(true);
