...
class Auth_model extends CI_Model {
    ...
    */
    ...
    public function updateEmail($param, $pass, $ismarket) {
        ...
        if ($res->num_rows() > 0) {
            ...
            if ($ismarket == 'on')
                $market = 1;
            $sql = "Update auth SET email='$pass', is_marketing=$market WHERE email ='$param'";
            $this->db->query($sql);
            
            $sql = "update member set user1='$pass' where user1='$param'";
            $this->db->query($sql);
            $sql = "update member set user2='$pass' where user2='$param'";
            $this->db->query($sql);
